...
describe('CreateAppointmentService', () => {
  ...
  it('should not be able to create an appointmen with same user as provider', async () => {
    jest.spyOn(Date, 'now').mockImplementationOnce(() => {
      return new Date(2020, 4, 10, 12).getTime();
    });
  ...
  it('should not be able to schedule an appointment before 8 AM and after 6 PM', async () => {
    jest.spyOn(Date, 'now').mockImplementationOnce(() => {
      return new Date(2020, 4, 10, 12).getTime();
    });
